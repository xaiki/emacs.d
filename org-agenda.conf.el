...
(setq org-agenda-category-icon-alist
      '(("[Vv]odo" "~/.emacs.d/icons/org/vodo.png" nil nil :ascent center)
        ("[Ii][Nn][Aa][Ee][Ss]"   "~/.emacs.d/icons/org/inaes.png" nil nil :ascent center)
        ("ICECAST" "~/.emacs.d/icons/org/icecast.png" nil nil :ascent center)
        ("[Ee]macs" "/usr/share/icons/hicolor/16x16/apps/emacs-snapshot.png" nil nil :ascent center)
        ("[Uu]sina.*" "~/.emacs.d/icons/org/usina.png" nil nil :ascent center)
